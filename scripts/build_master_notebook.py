    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "# 6. Push new version branch to GitHub (non-interactively)\n",
                "if GITHUB_TOKEN:\n",
                "    !GIT_TERMINAL_PROMPT=0 git push https://{GITHUB_TOKEN}@github.com/KMohnishM/HealthCare_Analytics.git {version_tag}\n",
                "    print(f'\\n🎉 Successfully pushed branch \"{version_tag}\" with all files to GitHub!')\n",
                "else:\n",
                "    print('\\n⚠️ GITHUB_TOKEN secret not found! Add GITHUB_TOKEN under Kaggle Add-ons -> Secrets to auto-push outputs.')"
            ]
        }
    ],
    "metadata": {
